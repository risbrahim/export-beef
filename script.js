...
function genBatches() {
  const farms   = ['Feedlot Bogor Export - Bogor','Feedlot Ciawi Prime - Bogor','Processing Hub Cibinong - Depok','Export Center Bekasi - Bekasi'];
  const statuses = ['Di Farm','Dalam Proses','Cold Storage','Distribusi','Export','Terjual'];
...
const TIMELINE = [
  ...
  { stage:'Export / Pasar', lokasi:'Supermarket & Pasar Modern', tanggal:'10/02/2024', durasi:'—', status:'waiting', catatan:'—' },
];
...
═══════════════════════════ */
const pageMeta = {
  dashboard:   { title:'Dashboard Utama',      sub:'Ringkasan operasional supply chain agroindustri daging sapi ekspor' },
...
function initDashboard() {
  ...
  const statusCls = { 'Di Farm':'badge-blue','Dalam Proses':'badge-amber','Cold Storage':'badge-purple','Distribusi':'badge-amber','Export':'badge-green','Terjual':'badge-green' };
...
function initSupplyChain() {
  ...
  const labels = { farm:'🌾 Farm', processing:'🔪 RPH', storage:'❄️ Cold Storage', distributor:'🚛 Distribusi', retailer:'🏪 Export' };
...
/* ═══════════════════════════
   MASTER DATA
═══════════════════════════ */
const masterTitles = { farm:'🌾 Data Farm', distributor:'🚛 Data Distributor', retailer:'🏪 Data Export' };
